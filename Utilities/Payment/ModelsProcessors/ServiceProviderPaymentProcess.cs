...
namespace Utilities
{
    public class ServiceProviderPaymentProcess : IPaymentProcessor<ServiceProviderPayment>
    {
        private readonly StripeService _stripeService;
        private readonly PayPalService _payPalService;

        public ServiceProviderPaymentProcess(StripeService stripeService, PayPalService payPalService)
        {
            _stripeService = stripeService;
            _payPalService = payPalService;
        }

        public ServiceResult ProcessPayment(ServiceProviderPayment payment)
        {
            try
            {
                ...
                var orderId = payment.RequestId.ToString();
                ...
                return ServiceResult.SuccessResult("Service Request payment completed.");
            }
            catch (Exception ex)
            {
